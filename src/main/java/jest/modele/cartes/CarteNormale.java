...
/**
 * Représente une carte normale du jeu (2, 3 ou 4 d'une couleur).
...
public class CarteNormale extends Carte {
    ...
    public CarteNormale(Couleur couleur, int valeurFaciale) {
        ...
        if (valeurFaciale < 2 || valeurFaciale > 4) {
     ...
     * Pour les cartes normales (2-4), la valeur est toujours la valeur faciale.
